...
<<<<<<< HEAD:src/Main/application/controllers/ManageTask.java
<<<<<<< HEAD:src/Main/application/actions/ManageTask.java
import Main.application.app.Menu;
import Main.application.app.Task;
import Main.application.app.ToDoList;
=======
=======
>>>>>>> master:src/Main/application/actions/ManageTask.java
import Main.application.view.Menu;
import Main.application.view.ToDoList;

>>>>>>> origin/master:src/Main/application/controllers/ManageTask.java
